...
VOID Device::PopulateCommandList()
{
	...
	m_pCommandList->IASetVertexBuffers(0, 1, &g_HelloMain->m_pRenderRect->m_tVBView);
	m_pCommandList->DrawInstanced(g_HelloMain->m_pRenderRect->m_nVBSize / sizeof(VtxTex), 1, 0, 0);
...
VOID Device::LoadAssets()
{
	...
	// Create the texture.
	{
		...
		D3D12_SUBRESOURCE_DATA textureData{ &g_HelloMain->GetColorList()[0], WINSIZEX * sizeof(XMFLOAT4), textureData.RowPitch * WINSIZEY };
